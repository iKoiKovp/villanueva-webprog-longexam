    ...
    <div className="flex w-full flex-col gap-6">
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          <div className="rounded-3xl border-2 border-dashed border-amber-300 bg-amber-100 p-6">
            <div className="flex min-h-72 items-center justify-center rounded-[1.25rem] bg-amber-200">
              <img src={logo} alt="BulldogEx" className="h-32 w-32 rounded-full border-2 border-amber-900 bg-amber-50 object-contain" />
            </div>
          </div>
      ...
      <section className="border-y-2 border-amber-900 bg-amber-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="mb-6">
          ...
          <h2 className="mt-2 text-2xl font-semibold text-amber-900">Quick store blocks</h2>
        </div>
      ...
      <section className="border-y-2 border-amber-900 bg-amber-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-semibold text-amber-900">Stacked shopping wireframe</h2>

            <div className="mt-6 space-y-4">
              <article className="rounded-3xl border-2 border-amber-900 bg-amber-100 p-5">
                <h3 className="text-lg font-semibold text-amber-900">Curated Catalog</h3>
              ...
              <article className="rounded-3xl border-2 border-amber-900 bg-amber-100 p-5">
                <h3 className="text-lg font-semibold text-amber-900">Simple Checkout</h3>
                <p className="mt-3 text-sm leading-6 text-amber-600">
              ...
              <article className="rounded-3xl border-2 border-amber-900 bg-amber-100 p-5">
                <h3 className="text-lg font-semibold text-amber-900">Pickup Ready</h3>
                <p className="mt-3 text-sm leading-6 text-amber-600">
