    ...
    <div className="flex w-full flex-col gap-6">
      <section className="border-y-2 border-amber-900 bg-amber-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-lg leading-7 text-amber-600">
      ...
      <section className="border-y-2 border-amber-900 bg-amber-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-2 text-2xl font-semibold text-amber-900">Explore the site</h2>
          
          <div className="mt-6 space-y-3">
            <div className="rounded-3xl border-2 border-amber-900 bg-amber-100 p-4">
              <h3 className="font-semibold text-amber-900">Home</h3>
              <p className="mt-1 text-sm text-amber-600">Return to the homepage</p>
              <Button to="/" className="mt-3">Go Home</Button>
            </div>
            
            <div className="rounded-3xl border-2 border-amber-900 bg-amber-100 p-4">
              <h3 className="font-semibold text-amber-900">Products</h3>
              <p className="mt-1 text-sm text-amber-600">Browse all featured store items</p>
